    ...
    Describe "Get-GeekJoke" {
        ...
        Context "Behaviour of Function Calling" {
            ...
            It "Invoke-RestMethod Reaches only the Geek api" {
                Assert-MockCalled -CommandName Invoke-RestMethod -ParameterFilter { $uri -eq 'https://sv443.net/jokeapi/v2/joke/Programming?blacklistFlags=nsfw,religious,political' }
            }
        }
